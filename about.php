  ...
  <section class="section about-section-alt" aria-labelledby="bio-heading" data-reveal>
    <div class="container about-two-col">
      <div class="about-copy">
        ...
        <p>Based in Monterey Bay, CA, working with research teams, market research agencies, and enterprise clients everywhere.</p>
      </div>
      ...
      <aside class="snapshot-card" aria-labelledby="snapshot-heading">
        ...
        <div class="snapshot-row">
          ...
          <p class="snapshot-value">Monterey Bay, CA, serving clients across North America, Europe, and globally via remote engagement.</p>
        </div>
      </aside>
    </div>
  </section>
