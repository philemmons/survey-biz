  ...
  <section class="hero" aria-labelledby="pricing-hero-heading">
    <div class="container">
      ...
      <p class="hero-sub">No retainers. No agency markup. A custom quote based on exactly what your study needs.
        <br><br>
        <strong>Survey programming</strong> sits at the intersection of research design and technical execution. The cost of a project reflects genuine scope â€” not package tiers built around the average project, and not hourly uncertainty that expands without limit.
      </p>
    </div>
  </section>
    ...
    <section class="section">
      ...
      <div class="pricing-factor-list mt-4" aria-labelledby="s1-heading" data-reveal>
        <div class="panel pricing-factor" aria-labelledby="s1-heading">
          ...
          <p class="card-body-text">Total questionnaire length is the most straightforward cost driver. Each question requires scripting, input-type configuration, validation rules, and QA verification. Section depth â€” how questions are organized into blocks, rotations, or randomized sets â€” multiplies that work. A 20 question survey with flat structure and a 20 question survey with block randomization, carry forward answer pipes, and custom display templates are very different builds.</p>
      ...
      <div class="pricing-factor-list mt-4" aria-labelledby="s2-heading" data-reveal>
        <div class="panel pricing-factor">
          ...
          <p class="card-body-text">Branching, skip patterns, display logic, piping, quota management, and custom JavaScript or CSS validations each add implementation and testing scope. A simple linear survey scripts in hours. A study with nested quota logic, conditional question text, mid-survey redirects, and custom end-page routing can require days of structured QA alone. Logic errors in deployed surveys corrupt data and require re-contact â€” the cost of getting it wrong far exceeds the cost of getting it right the first time.</p>
      ...
      <div class="pricing-factor-list mt-4" aria-labelledby="s3-heading" data-reveal>
        <div class="panel pricing-factor">
          ...
          <p class="pricing-factor-note"><strong>Market context:</strong> Multi-market research studies running across several countries can run $150,000 or more, at the agency level â€” localization and field logistics account for a large share of that premium. Direct programming dramatically reduces this overhead.</p>
        </div>
      </div>
      ...
      <div class="pricing-factor-list mt-4" aria-labelledby="s4-heading" data-reveal>
        <div class="panel pricing-factor">
          ...
          <p class="pricing-factor-note"><strong>What this covers:</strong> LimeSurvey's token-based participant management, email queue setup, bounce handling, and outreach timing workflows â€” tasks that are often underestimated when clients receive platform-only quotes.</p>
        </div>
      </div>
      ...
      <div class="pricing-factor-list mt-4" aria-labelledby="s6-heading" data-reveal>
        <div class="panel pricing-factor">
          ...
          <p class="feature-title" id='s6-heading'>Timeline & Turnaround</p>
          <p class="card-body-text">Delivery speed is a real resource constraint, not a filler factor. A study with clear specifications, no mid-build revisions, and a reasonable runway can often be delivered within a few business days. Compressed timelines â€” same-day or next-day launches, weekend fielding windows, or concurrent builds across multiple studies â€” require schedule prioritization that affects other commitments. Revision windows during QA also influence scheduling: one round of consolidated feedback is faster and cheaper to address than iterative single-item change requests.</p>
    ...
    <section class="section" aria-labelledby="included-heading" data-reveal>
      ...
      <div class="pricing-compare-grid mt-4" aria-labelledby="comparison-cards-heading">
        <article class="panel pricing-compare-card">
          ...
          <ul class="stack-3">
            <li>Rate uncertainty â€” scope creep bills at the same rate</li>
      ...
      <div class="faq-list faq-list--pricing mt-4">
        <details class="faq-item">
          ...
          <div class="faq-answer">
            <p>Many studies can be delivered within two to three business days when a finalized questionnaire document is provided at the start. The bottleneck in survey programming is rarely the programming itself â€” it's the specification. Studies that arrive with wording still in flux, logic not yet confirmed, or sample targets undecided require back-and-forth that adds days to any timeline.</p>
        ...
        <details class="faq-item">
          ...
          <div class="faq-answer">
            <p>LimeSurvey is the primary platform. It is open-source, self-hostable, and fully-featured â€” supporting advanced branching, piping, quota logic, multilingual deployment, token-based participant management, and custom styling without per-response pricing or enterprise license fees. This keeps client costs focused on expertise, not platform rent.</p>
            <p>For context: Qualtrics enterprise licensing ranges from a few thousand to over $100,000 per year depending on organizational scale. LimeSurvey Cloud plans run â‚¬29 to â‚¬170/month, and self-hosted instances are license-free. The platform choice has a direct impact on your total project cost.</p>
        ...
        <details class="faq-item">
          ...
          <div class="faq-answer">
            ...
            <p>Translation content is provided by the client or a translation partner â€” this is not a translation service. What this service covers is the technical integration, QA, and deployment of translated content into a working, validated multilingual survey.</p>
        ...
        <details class="faq-item">
          ...
          <div class="faq-answer">
            ...
            <p>A project-based quote defines the deliverable and the price together. Changes to scope can be scoped and quoted as additions â€” but the base project has a known cost. For research teams with fixed budgets per study, this predictability has direct operational value.</p>
          </div>
        </details>
        <details class="faq-item">
